               ...
               <div class="col-sm" id="caneta" style="display: unset;">
                  ...
                  <div class = "container2">
                     <form class = "row" action="{{route('register')}}" method="POST">
                        ...
                        <div class="col-sm-12">
                           <input type = "text" class = "form-control" name = "cnpj" placeholder = "CNPJ" required autofocus minlegth = "14" value="{{old('cnpj')}}">
                        ...
                        <div class="col-sm-7">
                           <input type = "number" class = "form-control" name = "tel" placeholder = "TELEFONE" value="{{old('tel')}}" required>
                        ...
                        <div class="col-sm-12">
                           <textarea name = "sobrenos" class = "form-control" cols = "20" rows = "8" placeholder = "Sobre Nós" value="{{old('sobren')}}" required></textarea>
